  ...
  <div class="container">
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            ...
            <input type="datetime-local" id="datePointage" name="datePointage" class="form-control" required>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <select id="pointage" name="pointage" class="form-control" required>
...
if (isset($_POST['submit'])) {
    ...
    $requete = $connexion->prepare("INSERT INTO POINTAGE (datePointage, numEmp, pointage)
                                    VALUES (:datePointage, :numEmp, :pointage)");

    
    $requete->bindParam(':datePointage', $datePointage);
    $requete->bindParam(':numEmp', $numEmp);
    $requete->bindParam(':pointage', $pointage);
